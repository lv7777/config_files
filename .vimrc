...
" Required:
set runtimepath+=/root/.vim_runtime/repos/github.com/Shougo/dein.vim

" Required:
if dein#load_state('/root/.vim_runtime')
  call dein#begin('/root/.vim_runtime')

  " Let dein manage dein
  " Required:
  call dein#add('/root/.vim_runtime/repos/github.com/Shougo/dein.vim')
  ...
  " call dein#add('Shougo/deol.nvim', { 'rev': 'a1b5108fd' }) " it is required with neovim
